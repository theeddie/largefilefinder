...
echo ""
echo -e "${BLUE}Exclusions applied:${NC}"
echo -e "• Mounted drives (/mnt, /media, /Volumes)"
echo -e "• Network shares (NFS, CIFS, S3FS, SSHFS)"  
echo -e "• Clone directories (*/clone)"
echo -e "• S3 mount points (*/s3*)"
echo -e "• System dirs (/proc, /sys, /dev, /tmp)"
echo -e "• Cache dirs (*/.cache, */node_modules, */.git)"
echo ""
echo -e "${BLUE}Tips for faster searches:${NC}"
echo -e "• Use smaller max depth (2-3) for very fast results"
echo -e "• Script automatically excludes network/mounted drives"
echo -e "• For complete local scan: find /path -size +1G -ls"
